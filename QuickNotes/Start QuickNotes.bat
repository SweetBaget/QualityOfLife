...
rem
rem  Tip: to pin the app to the taskbar or place it on the desktop,
rem  create a shortcut to this .bat and assign AppIcon.ico as its
rem  icon (Shortcut Properties -> Change Icon...).
rem ============================================================
